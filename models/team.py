...
class Team:
    ...
    def __init__(self, puce: int, dossard: int, ent: bool, mixite: str, team_name: str, concs_list: list[tuple[str,str]], contact: str):
        self.puce = puce
    ...
    def __eq__(self, other):
        ...
        if isinstance(self, other.__class__):
            return self.puce == other.puce and self.dossard == other.dossard and self.team_name == other.team_name
        return False